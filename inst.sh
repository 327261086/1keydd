...
export autoDEBMIRROR0=https://github.com/minlearn/1keydd/raw/master
export autoDEBMIRROR1=https://gitee.com/minlearn/1keydd/raw/master
  ...
  case $1 in
    ...
    -t|--target)
      ...
      case $tmpTARGET in
        ...
        /*) [[ "$autoDEBMIRROR0" =~ "/1keydd/raw/master" ]] || { IMGMIRROR0=${autoDEBMIRROR0}"/.." && tmpTARGET0=$tmpTARGET && tmpTARGET=`echo "$tmpTARGET0" |sed "s#^#$IMGMIRROR0#g"`; }; tmpTARGETMODE='0' ;;
...
if [[ "$tmpTARGETMODE" == '0' || "$tmpTARGETMODE" == '4' ]]; then
  ...
  [[ "$DEBMIRROR" =~ "/1keydd/raw/master" ]] && IMGMIRROR=${DEBMIRROR/\/1keydd\/raw\/master/}"/xxxxxx/raw/master" || IMGMIRROR=${DEBMIRROR/\/1keydd/}"/xxxxxx"
else
  # force to main github
  DEBMIRROR=$autoDEBMIRROR0 && echo -en "[ \033[32m force,${DEBMIRROR} \033[0m ]";[[ "$DEBMIRROR" =~ "/1keydd/raw/master" ]] && IMGMIRROR=${DEBMIRROR/\/1keydd\/raw\/master/}"/xxxxxx/raw/master" || IMGMIRROR=${DEBMIRROR/\/1keydd/}"/xxxxxx";
fi
